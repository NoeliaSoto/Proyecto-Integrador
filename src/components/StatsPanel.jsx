function StatsPanel({ total, max, min, longTitles, totalPrice, avgDiscount, highStock, highRating, avgRating }) {
  return (
    <section className="container mx-auto max-w-3xl p-6 mb-6 bg-slate-100 dark:bg-slate-800 rounded-lg shadow fade-in">
      <header className="mb-4">
        <h2 className="text-blue-900 dark:text-white text-2xl font-semibold">Resumen de Estadísticas</h2>
      </header>

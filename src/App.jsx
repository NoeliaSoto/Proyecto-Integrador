...
function App() {
  ...
  return (
    <div ref={appRef} className="min-h-screen bg-white text-black dark:bg-gray-900 dark:text-white transition-colors duration-300">
      ...
      <button
        onClick={() => appRef.current.classList.toggle('dark')}
